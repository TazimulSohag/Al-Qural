package com.banglabs.al_quran.external
...
class TACPP(val context: Activity) {
    ...
    companion object {
        ...
        private const val condition = "\">" +
                ...
                "                  to it, still belong to Nelu Code.\n" +
                "                $p\n" +
                "                  Nelu Code is committed to ensuring that the app is\n" +
                ...
                "                  Nelu Code will not take responsibility for. Certain\n" +
                "                  functions of the app will require the app to have an active\n" +
                "                  internet connection. The connection can be Wi-Fi, or provided\n" +
                "                  by your mobile network provider, but Nelu Code\n" +
                ...
                "                $p\n" +
                "                  Along the same lines, Nelu Code cannot always take\n" +
                "                  responsibility for the way you use the app i.e. You need to\n" +
                "                  make sure that your device stays charged – if it runs out of\n" +
                "                  battery and you can’t turn it on to avail the Service,\n" +
                "                  Nelu Code cannot accept responsibility.\n" +
                "                $p\n" +
                "                  With respect to Nelu Code’s responsibility for your\n" +
                "                  use of the app, when you’re using the app, it’s important to\n" +
                "                  bear in mind that although we endeavour to ensure that it is\n" +
                "                  updated and correct at all times, we do rely on third parties\n" +
                "                  to provide information to us so that we can make it available\n" +
                "                  to you. Nelu Code accepts no liability for any\n" +
                ...
                "                  using the app. Nelu Code does not promise that it\n" +
                ...
                "                $p\n" +
                "                  These terms and conditions are effective as of 2023-08-05\n" +
                "                $p<strong>Contact Us</strong>$p\n" +
                "                  If you have any questions or suggestions about my\n" +
                "                  Terms and Conditions, do not hesitate to contact me\n" +
                "                  at <strong>alquran@abmclouds.com</strong>.\n" +
                "</font>" +
                "    </body>\n" +
                "    </html>\n" +
                "      "
        ...
        private const val policy =  "\">" +
                ...
                "                  Nelu Code built the Al-Quran app as\n" +
                "                  a Free app. This SERVICE is provided by\n" +
                "                  Nelu Code at no cost and is intended for use as\n" +
                "                  is.\n" +
                "                $p\n" +
                ...
                "                  this page.\n" +
                "                $p This policy is effective as of 2023-08-05$p<strong>Contact Us</strong>$p\n" +
                "                  If you have any questions or suggestions about my\n" +
                "                  Privacy Policy, do not hesitate to contact me at <strong>alquran@abmclouds.com</strong>.\n" +
                "</font>" +
                "    </body>\n" +
                "    </html>"
    }
